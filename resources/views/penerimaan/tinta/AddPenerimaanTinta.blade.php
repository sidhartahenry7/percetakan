            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">Penerimaan Tinta</h4>
                    </div>
                    ...
                    <form action="/penerimaan-tinta" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <input type="text" readonly="readonly" class="form-control" id="id_pembelian_tinta" autofocus value="{{ $pembelian->id_pembelian_tinta }}"/>
                                    <input type="hidden" readonly="readonly" class="form-control @error('pembelian_tinta_id') is-invalid @enderror" id="pembelian_tinta_id" name="pembelian_tinta_id" required value="{{ $pembelian->id }}"/>
                                    @error('pembelian_tinta_id')
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-2">
                                    <label for="pegawai_id">PIC</label>
                                </div>
                                <div class="col-3">
