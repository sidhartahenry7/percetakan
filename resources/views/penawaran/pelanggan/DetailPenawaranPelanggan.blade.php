        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-danger" onclick="location.href='{{ url('daftar-penawaran') }}'" style="margin-right: 10px;">
                        Back
                    </button>
                </div>
                ...
                <div class="iq-card-body">
                    ...
                    <div id="detail">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <p class="card-text" style="color: black; font-size: 16px;">{{ $penawaran->status_penawaran }}. Harap menunggu konfirmasi pegawai!</p>
                                    @else
                        ...
                        @if($penawaran->status_penawaran != "Selesai" && $penawaran->status_penawaran != "Batal" && $penawaran->status_penawaran != "Menunggu konfirmasi pembayaran")
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="row align-middle">
                                                    <div class="col-sm-12">
                                                        @isset($detail->kategori->gambar_kategori)
                                                        <img class="card-img responsive" src="{{ asset('/storage/'.$detail->kategori->gambar_kategori) }}" style="height: 200px;" alt="Card image cap">
                                                        @else
                                                        <img class="card-img responsive" src="{{ asset('/storage/kategori/null.jpg') }}" style="height: 200px;" alt="Card image cap">
                                                        @endisset
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <h6 class="card-title">{{ $detail->kategori->nama_kategori }}</h6>
                                                        @else
                                                        <h4 class="card-title">{{ $detail->kategori->nama_kategori }}</h4>
                                                        @endisset
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <button type="button" onclick="location.href='{{ url('file-penawaran/'.$detail->id) }}'" class="btn btn-primary btn-sm"><span class="material-icons align-middle">description</span> Download</button>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <label for="jumlah_total_item">{{ $penawaran->jumlah_total_item }}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <label for="sub_total_transaksi">Rp {{ number_format($penawaran->sub_total_transaksi, 2) }}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <label for="promo_id">{{ $penawaran->promo->potongan }}%</label>
                                                                @else
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <label for="total" style="font-size: 18px;"><b>Rp {{ number_format($penawaran->total, 2) }}</b></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-0">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="hidden" id="jumlah_total_item" name="jumlah_total_item" value="{{ $penawaran->jumlah_total_item }}"/>
                                                                <input type="hidden" id="sub_total_transaksi" name="sub_total_transaksi" value="{{ $penawaran->sub_total_transaksi }}"/>
                                                                <input type="hidden" id="promo_id" name="promo_id" value="{{ $penawaran->promo_id }}"/>
                                                                <input type="hidden" id="total" name="total" value="{{ $penawaran->total }}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                @if($penawaran->status_penawaran == "Menunggu pembayaran")
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form action="{{ url('/penawaran/'.$penawaran->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <input type="file" class="form-control @error('bukti_pembayaran') is-invalid @enderror" id="bukti_pembayaran" name="bukti_pembayaran" required value="{{ old('bukti_pembayaran') }}"/>
                                ...
                                @endif
                                @isset($penawaran->bukti_pembayaran)
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <button type="button" onclick="location.href='{{ url('bukti-pembayaran/'.$penawaran->id) }}'" class="btn btn-primary btn-sm"><span class="material-icons align-middle">description</span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <table class="table table-striped table-borderless" id="dtBasicExample">
                                ...
                                @foreach ($list_status as $status)
                                    <tr>
                                        ...
                                        <td>{{ $status->pegawai->nama_lengkap }} (Soerabaja45)</td>
                                        @else
