    ...
    <div class="wrapper">
        ...
        <form action="{{ url('/register') }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama_pelanggan" name="nama_pelanggan" placeholder="Nama Lengkap">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="text-center fs-6">
                <label class="text-center">Already Registered? <a href="/login">Login Now!</a></label>
            </div>
        </form>
    </div>
</body>
