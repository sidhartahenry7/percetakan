        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    ...
                    @endif
                    <form action="{{ url('user-change-password/'.auth('pelanggan')->user()->id) }}" method="post">
                        @csrf
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    <input type="hidden" class="form-control @error('email') is-invalid @enderror" id="email" name="email" required autofocus value="{{ auth('pelanggan')->user()->email }}"/>
                                    @error('email')
