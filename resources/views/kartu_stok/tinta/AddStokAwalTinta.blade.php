...
<body>
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">Add Stok Awal Tinta</h4>
                    </div>
                ...
                <div class="iq-card-body">
                    ...
                    @endif
                    <form action="{{ url('/add-stok-awal-tinta') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label for="text">Quantity Awal</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" id="quantity_masuk" value="0"/>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label for="text">Harga Beli</label>
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="harga_beli" value="0"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label for="text">Harga Average</label>
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="harga_average" value="0"/>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function tambahTinta() {
            ...
            var quantity_masuk = $('#quantity_masuk').val();
            var satuan = $('#satuan').val();
            var harga_beli = $('#harga_beli').val();
            var harga_average = $('#harga_average').val();
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (count == 0) {
                        if (satuan == "liter") {
                            quantity_masuk = parseFloat($('#quantity_masuk').val())*1000;
                            satuan = "mL";
                        }
                        else {
                            quantity_masuk = $('#quantity_masuk').val();
                            satuan = "mL";
                        }
                        $('#table_del_tinta').append('<tr>\
                                                      <td>'+result.jenis_tinta+' '+result.warna+'</td>\
                                                      <td>'+quantity_masuk+' '+satuan+'</td>\
                                                      <td>'+Intl.NumberFormat('en-EN', { style: 'currency', currency: 'IDR', currencyDisplay: "narrowSymbol", }).format(harga_beli)+'</td>\
                                                      <td>'+Intl.NumberFormat('en-EN', { style: 'currency', currency: 'IDR', currencyDisplay: "narrowSymbol", }).format(harga_average)+'</td>\
                                                      ...
                                                      <td hidden><input type="hidden" name="quantity_masuk[]" value="'+quantity_masuk+'"/></td>\
                                                      <td hidden><input type="hidden" name="satuan[]" value="'+satuan+'"/></td>\
                                                      <td hidden><input type="hidden" name="harga_beli[]" value="'+harga_beli+'"/></td>\
                                                      <td hidden><input type="hidden" name="harga_average[]" value="'+harga_average+'"/></td>\
                                                      </tr>');
                    }
                }
            });
